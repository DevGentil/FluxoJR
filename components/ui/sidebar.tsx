...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        // `min-w-0` junto do `w-full`: como item de flex ao lado do menu,
        // sem isso ele nunca encolhe abaixo do proprio conteudo e fica com
        // a largura inteira da janela — que somada ao menu passa da tela.
        // Era a origem de todo o corte: a tabela ja rolava dentro da
        // propria caixa, mas ninguem apertava o conteudo para isso valer.
...
function SidebarGroupLabel({
  ...
  return useRender({
    ...
    props: mergeProps<"div">(
      {
        className: cn(
          // `pointer-events-none` na barra de icones: o rotulo fica
          // invisivel por opacidade e puxado para cima por `-mt-8`, mas
          // continua ocupando a area — e como ele sobe por cima do item
          // anterior, era ELE que recebia o clique. Era o que impedia
          // acertar o Dashboard com o menu recolhido.
